...
class _MainScreenState extends State<MyApp>{
  ...
  File out;
  var num=0;
  //cartoon contiene el string parseado de la imagen convertida, la funcion getCartoon 
  //Lo modifica
  var cartoon; 

  getCartoon()  async{
    var pathCartoon="/data/user/0/com.example.pictureconverter/cache/cartoon$num.png";
    var image = _image;
    var imageAsBytes = await image.readAsBytes();
    var uri = Uri.parse('http://192.168.0.18:5000/cartoon');
    print(uri);
  ...
  //FUNCION PARA COMPARTIR EN GMAIL
  void gmail() {
  ...
  void whatsapp() {
    //const String BASE64_IMAGE =
    //"data:image/png;base64,";
    //const String MYBASE64_IMAGE = cartoon;
    AdvancedShare
        .whatsapp(msg: "It's okay :)", url: cartoon)
        .then((response) {
      handleResponse(response, appName: "Whatsapp");
    });
  }
  /*void whatsapp2() {
    //SE ESTA HACIENDO BIEN LA CONVERSION?
    Image myimage = Image.file(out);
    List<int> imageBytes = myimage.readAsBytesSync();
    var encoded = base64.encode(imageBytes);
    print(encoded);
    //String base64Image = base64Encode(imageBytes);
    //var imagen = out;
    //var bytes = imagen.readAsBytes().toString();
    
    AdvancedShare
        .whatsapp(msg: "ghghgh", url: encoded)
        .then((response) {
          //print(base64Image);
      handleResponse(response, appName: "Whatsapp");
    });
  ...
  Future getImage() async{
    ...
    setState(() {
      ...
      //out = image;
      /*out2 = image;
      List<int> imageBytes = out2.readAsBytesSync();
  ...
  Widget build(BuildContext context){
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Photo Draw Converter"),
          // Aqui va a ir un icono para ver la galeria de imagenes
        ),
        body: Center(
            child: ListView(
                children: <Widget>[
                  _image == null ? Text("Welcome to Photo Draw") : Image.file(_image),
                  out   == null ? Text("") : Image.file(out),
                  out == null && _image == null ? Text("") : new ListTile(
                    title: Text("share"),
                    onTap: whatsapp,
                  ),
                  /*out == null && _image == null ? Text("") : new RaisedButton(
                    child: Text("Share"),
                    onPressed: whatsapp,
                  ),*/
                ]
